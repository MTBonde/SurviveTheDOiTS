...
namespace ECS.Systems
{
    ...
    public partial struct BoidAttackSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            float resetDistance = boidSettings.AttackRange / 4f;
            float attackSpeed = boidSettings.MoveSpeed * 1.25f; // Adjusted attack speed
                         ...
                         .WithEntityAccess())
            {
                ...
                // Update direction and speed for direct attack
                directionComponent.ValueRW.Direction = directToPlayer;
